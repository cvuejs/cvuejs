<template>
  <el-form class="c-form" :ref="$options.name" v-bind="binds">
    <ValidationForm class="c-form__container" ref="observer" as="div">
      <FormItem
...
export default defineComponent({
  ...
  inheritAttrs: false,
  components: { ElForm, ValidationForm: Form, FormItem: FormItem },
  emits: ['output-change'],
  props: {
    c: {
